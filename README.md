...
1. **Console scan** — colorized findings sorted by risk.
2. **SigNoz dashboard** — high/medium/low counts, total scans, and per-machine fleet activity.
3. **Live Slack alert** — `[FIRING:1] High-Risk AI Tool Detected` firing automatically when a scan detects high-risk items.
